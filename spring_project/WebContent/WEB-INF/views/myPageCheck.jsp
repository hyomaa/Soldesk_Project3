...
<body>
<form action="myPageModify" name="myPageModify">
	<div id="wrapper">
		<div class="top_write" style="padding: 0 0 30px 0;">
			<h1 style="text-align: center; color: #444;">마이페이지</h1>
			...
			<!-- 아이디 , email text , 중복버튼 -->
			<div style="border-bottom: 1px solid #d5d5d5; height: 70px; width: 306px; margin: 0 auto;">			
				<!-- <label style="font-size: 1.05em; position: relative; top: 11px;">아이디</label> -->				
				<!-- <span style="color: red; position: relative; top: 11px;">*</span> -->
				<input type="text" name="user_id" id="user_id" style="font: 400 13.3333px Arial; width: 300px; height: 40px; position: relative; top: 11px;" maxlength="50" required="required" value="${loginUser.user_id }" />								
			...
			<div style="border-bottom: 1px solid #d5d5d5; height: 70px; width: 306px; margin: 0 auto;">
				...
				<input type="password" name="user_pw" id="user_pw" style="font: 400 13.3333px Arial; width: 300px; height: 40px; position: relative; top: 11px;" maxlength="50" required="required" />																
				<!-- <p style="position: relative; top: -30px; left: 600px;">최소 10자이상, 영문+숫자 조합</p> -->				
			</div>		
			
				<div style="width: 100%">				
					<div style="width: 306px; margin: 0 auto; padding-top: 30px;">					
						<input type="submit" value="확인" style="text-align: center; width: 306px; line-height: 40px; height: 50px; color: #fff; background: #444; font-size: 1.2em; border: 1px solid #444; margin: 0 auto;" id="sub" />
